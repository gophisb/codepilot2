...
10. The standalone index.html reader must remain isolated from the existing project state; upload/copy/preview must not mutate generatedFiles.
11. Standalone index.html preview must stay sandboxed and must not gain GitHub or AI credentials.
12. For GitHub URL errors, distinguish parsing errors, HTTP 404/403, network failures, and repository permissions.

...
`الهاتف → GitHub Pages → GitHub Actions → AI → مستودع GitHub مستقل → CodePilot2-gophisb Loader`
...
- **CodePilot2-gophisb:** يستطيع تحميل المستودع العام الناتج وعرض الملفات والكود وتعديله محلياً وفتح معاينة مؤقتة.
...
7. انسخ رابط المستودع إلى خانة **تحميل المشروع الناتج** داخل CodePilot2-gophisb.
8. ستظهر الملفات، ويمكن تعديل الكود ونسخه وتجربة `index.html` في المعاينة المؤقتة.

## الكود والملفات والمعاينة

واجهة CodePilot2-gophisb تحتوي الآن على:
...
ثم ينشأ مستودع مستقل ويُدفع إليه المشروع. لا يتم تعديل `main` في CodePilot2-gophisb.
...
CodePilot2-gophisb ليس مجرد مولّد نصوص. المسار المستهدف:
